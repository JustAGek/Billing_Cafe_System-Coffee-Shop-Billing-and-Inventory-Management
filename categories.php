						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Name (EN): <b><?php echo $row['name'] ?></b></p>
										<p>Name (AR): <b><?php echo $row['name_ar'] ?></b></p>
										<p><small>Description: <b><?php echo $row['description'] ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-name_ar="<?php echo $row['name_ar'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
...
<script>
	...
	$('.edit_category').click(function(){
		...
		cat.find("[name='name_ar']").val($(this).attr('data-name_ar'))

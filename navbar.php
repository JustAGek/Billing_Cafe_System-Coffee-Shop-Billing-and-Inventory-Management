...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="billing/indexo.php" class="nav-item nav-takegoods"><span class='icon-field'><i class="fa fa-list-ol "></i></span> Take Goods</a>
				...
				<a href="index.php?page=goods" class="nav-item nav-goods"><span class='icon-field'><i class="fa fa-clipboard-list "></i></span> Goods</a>
				...
				<a href="index.php?page=goods_report" class="nav-item nav-goods_report"><span class='icon-field'><i class="fa fa-th-list"></i></span> Goods Report</a>
				<a href="index.php?page=birthday_report" class="nav-item nav-goods_report"><span class='icon-field'><i class="fa fa-th-list"></i></span> Birthday Report</a>
